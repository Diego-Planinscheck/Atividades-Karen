...
public class q02 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Codigo cidade: " + codigoMaior +  " Maior indice de acidente: " + (maior * 100)/somaAcidentes);
        System.out.println("Codigo cidade: " + codigoMenor + " Menor indice de acidente: " + (menor * 100)/somaAcidentes);
